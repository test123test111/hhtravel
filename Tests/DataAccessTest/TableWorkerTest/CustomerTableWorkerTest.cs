...
namespace DataAccessTest
{
    ...
    /// <summary>
    ///This is a test class for CustomerTableWorkerTest and is intended
    ///to contain all CustomerTableWorkerTest Unit Tests
    ///</summary>
    [TestClass()]
    public class CustomerTableWorkerTest
    {
        ...
        {
            CustomerTableWorker target = new CustomerTableWorker();
