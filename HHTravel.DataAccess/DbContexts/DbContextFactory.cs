        ...
        private static Dictionary<Type, DbContextConstructionArgumentBag<DbEntitiesBase>> s_dict =
            new Dictionary<Type, DbContextConstructionArgumentBag<DbEntitiesBase>>{
                { typeof(ProductDbEntities),
                     new DbContextConstructionArgumentBag<DbEntitiesBase>("ProductDB",
                    "ProductDb",
                ...
                { typeof(CustomerDbEntities),
                    new DbContextConstructionArgumentBag<DbEntitiesBase>("CustomerDB",
                    "CustomerDb",
                ...
                { typeof(OrderDbEntities),
                    new DbContextConstructionArgumentBag<DbEntitiesBase>("OrderDB",
                    "OrderDb",
                ...
                { typeof(GovDbEntities),
                    new DbContextConstructionArgumentBag<DbEntitiesBase>("GovDB",
                    "GovDb",
