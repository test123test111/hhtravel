...
namespace HHTravel.CRM.Booking_Online.DataAccess.Mock
{
    public class ProductRepositoryMock : ProductRepository
    {
        ...
        List<string> _productNoList = new List<string>();
        List<Product_Property> _ppList = new List<Product_Property>();
        //private static IEnumerable<Model.Product> s_Cache = null;

        private ProductTableWorker _internalRepo;
        // todo: 有木有internal protected
        internal override ProductTableWorker TableWorker
        {
            get
            {
                if (_internalRepo == null)
                {
                    _internalRepo = new ProductTableWorkerMock(this.ProductDbContext);
                }
        ...
        protected override IEnumerable<Interest> GetInterests(int productId)
        {
        ...
        {
            PictureTableWorkerMock repoMockPic = new PictureTableWorkerMock(ProductDbContext);
