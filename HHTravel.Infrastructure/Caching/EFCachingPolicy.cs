...
namespace HHTravel.Infrastructure.Caching
{
    ...
    /// </summary>
    public class EFCachingPolicy : CachingPolicy
    {
        /// <summary>
        /// Initializes a new instance of the CustomCachingPolicy class.
        /// </summary>
        public EFCachingPolicy()
        {
        ...
        /// </returns>
        protected override bool CanBeCached(EFCachingCommandDefinition commandDefinition)
        {
        ...
        protected override void GetCacheableRows(EFCachingCommandDefinition cachingCommandDefinition, out int minCacheableRows, out int maxCacheableRows)
        {
        ...
        protected override void GetExpirationTimeout(EFCachingCommandDefinition cachingCommandDefinition, out TimeSpan slidingExpiration, out DateTime absoluteExpiration)
        {
            slidingExpiration = System.Web.Caching.Cache.NoSlidingExpiration; // TimeSpan.FromMinutes(GlobalConfig.EFCachingExpiration);
            absoluteExpiration = DateTime.Now.AddMinutes(GlobalConfig.EFCachingExpiration); //System.Web.Caching.Cache.NoAbsoluteExpiration;
        }
    }
}