...
{
    /// <summary>
    ///This is a test class for OrderProductsProviderTest and is intended
    ///to contain all OrderssProviderTest Unit Tests
    ///</summary>
    [TestClass()]
    public class OrderProductsProviderTest
    {
        ...
        {
            OrderProductsProvider target = new OrderProductsProvider();
